...
<html><head>
    ...
    <div></div>
    	<nav class="navigation">
          <ul class="mainmenu">
              ...
              <li><a href="" ><i class="fa fa-hand-paper-o" aria-hidden="true" style="margin-right:10px;"></i>ATTENDANCE<i class="fa fa-chevron-right" aria-hidden="true" style="margin-left:110px;"></i></a>
               ...
               <li><a href="update_attendence.php" class="active"><i class="fa fa-undo" aria-hidden="true" style="margin-right:10px;"></i>UPDATE ATTENDANCE</a></li>
              <li>
     ...
     <!-- --------------------------------------------------------------------------------------------------------------------------->
      <form action="backend/update_attendence_valid.php" method="post">
         <div style="padding-top:90px; margin-left:400px;">
         <?php if($sec=='NA'){
               ?>
               <h3 style="margin-left:20%; margin-top:100px; color: #C82224; font-size:24px;">Only Class Teacher Can Update Attendence</h3>
               <?php               
               exit();
    }?>
...
function show(){
    ...
    if (window.XMLHttpRequest) {
        ...
        xmlhttp.open("GET","ajax/update_attendence_date_ajax.php?date="+date+"&x="+x+"&nclass="+nclass,true);
        xmlhttp.send();
