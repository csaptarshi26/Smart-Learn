    	...
    	<nav class="navigation">
          <ul class="mainmenu">
               ...
               <li>
                    ...
                    <li><a href="#" class="active">VIEW/UPDATE QUESTION</a></li>
                    </ul>
               </li>
...
<form action="backend/" method="post">
   <div style="padding-top:100px; margin-left:320px;">
    <?php if($sec=='NA'){
               ?>
               <h3 style="margin-left:25%; margin-top:100px; color: #C82224; font-size:24px;">Only Class Teacher Can view Question</h3>
               <?php               
               exit();
    }?>
   <span> Subject:</span>
   ...
   <span style="margin-left:30px;" hidden="true" id="spand">Date:</span>
   <input placeholder="&#xf271;" type="text" onfocus="(this.type='date')" onBlur="(this.type='text')" id="date" required min="<?php echo date("Y-m-d"); ?>" style="width:140px;font-family:Arial, FontAwesome;height:25px; padding-left:4px;" name="date" autocomplete="off" oninput="show()" hidden="true" onChange="visible1()">
...
function show(){
    ...
    if (window.XMLHttpRequest) {
        ...
        xmlhttp.open("GET","ajax/view_question_ajax.php?date="+date+"&sub="+subject+"&x="+x,true);
        xmlhttp.send();
